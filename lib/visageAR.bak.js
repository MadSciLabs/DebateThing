...
function VisageAR() {
	...
	*/
	...
	this.loadObject = function(url) {
				...
				loader.load( 'nose_diffuse.jpg', function ( image ) {
				...
				//Nose base
				loader.load( 'nose0.obj', function ( object ) {
				//loader.load( 'obj/cyl.obj', function ( object ) {
	...
	this.loadObject = function(url) {
		...
		mtlLoader.load( url + '.mtl', function( materials ) {
			...
			objLoader.load( url + '.obj', function ( object ) {
				...
				//object.position.set(0, 1, -5);
				object.position.set(-0.015394692309200764,0.007321545388549566,0.49525749683380127);
				object.rotation.set(-0.10774077475070953,3.0021172904968263,-0.015019436366856098);
	...
	*/
	var update = function() {
		...
		if (v_tracking && v_trackingStatus === Module.VisageTrackerStatus.TRACK_STAT_OK.value) 
		{
			...
			//v_glasses.position.set(-0.015394692309200764,0.007321545388549566,0.49525749683380127);
			//v_glasses.rotation.set(-0.10774077475070953,3.0021172904968263,-0.015019436366856098);
